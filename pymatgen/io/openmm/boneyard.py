...
# TODO: move this to an solution object?
...
# TODO: move this to a solution object?
...
def order_molecule_canonically(smile: str, geometry: pymatgen.core.Molecule):
    """
    Order sites in a pymatgen Molecule to match the canonical ordering generated by rdkit.
    """
    # TODO: we should infer the molecule upstream
...
def add_mol_charges_to_forcefield(
    ...
    charged_openff_mol: List[tk.Molecule],
) -> smirnoff.ForceField:
    """
    ...
    for smile in smile_strings:
        ...
        if not is_isomorphic:
            ...
            if openff_mol.n_atoms == 1:
                ...
                chg = (
                    np.array([openff_mol.total_charge._value])
                    * charge_scaling
                    * elementary_charge
                )
...
def assign_small_molecule_ff(molecules: List[tk.Molecule], forcefield_name: str):
    """
    Args:
...
def parameterize_system(
...
) -> Union[System, Tuple[System, List[tk.Molecule]]]:
    """
    ...
    if isinstance(force_field, str):
        ...
        template = assign_small_molecule_ff(
            molecules=charged_mols, forcefield_name=ff_name
        )
